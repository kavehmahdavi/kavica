...
# -*- coding: utf-8 -*-
"""
kavica is a Python package that provides semi-automated, flexible, and expressive clustering analysis designed to
make working with "unlabeled" data easy and intuitive.
...
Note:
    **ONLY**  -> python3 setup_factory.py install
"""
...
__major__, __minor__, __micro__ = (1, 1, 0)
__isreleased__ = True
...
__metadata__ = dict(
    version=__version__,
    name='kavica',
    maintainer="Dr. Kaveh Mahdavi",
    maintainer_email="kavehmahdavi74@yahoo.com",
...
def setup_package(metadata_avail=False):
    ...
    if run_build:
        ...
        try:
            ...
            print('=' * 70)
            print("We check the README for markup errors before uploading:")
            annotation_command = "twine check dist/*"
